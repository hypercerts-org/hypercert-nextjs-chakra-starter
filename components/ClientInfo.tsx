    ...
    useEffect(() => {
        if (indexer) {
            ...
            const getFirstHypercert = async () => {
                const firstHypercert = await indexer.recentHypercerts({});

                if (firstHypercert?.hypercerts.data && firstHypercert.hypercerts.data.length > 0) {
                    console.log(firstHypercert);
                    setFirstHypercert(firstHypercert.hypercerts.data[0]);
                }
            };
